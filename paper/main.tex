...
\textbf{FiLM vs.\ no-FiLM.} FiLM conditioning helps only marginally---about
1.5 points at $K{=}5$ and shrinking with more shots---and the across-seed bands
overlap (Fig.~\ref{fig:ablation}b), so we do not claim it as a reliable driver;
it is at best a minor contributor.
